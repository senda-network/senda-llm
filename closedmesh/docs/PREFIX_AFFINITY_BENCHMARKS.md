...
- The passive benchmark forces both serving hosts up with `CLOSEDMESH_FORCE_DUPLICATE_HOSTS=1` so the test measures routing rather than demand-driven duplicate-host promotion latency.
