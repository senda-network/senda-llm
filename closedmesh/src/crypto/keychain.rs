...
/// Service name used for all closedmesh keychain entries.
pub const KEYCHAIN_SERVICE: &str = "closedmesh";
...
/// The prefix matches `DEFAULT_OWNER_ACCOUNT` so users can identify closedmesh
