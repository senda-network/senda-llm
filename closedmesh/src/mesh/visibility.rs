...
mod tests {
    ...
    // closedmesh.com is the only thing standing between an invisible
    ...
    fn peer_report_body_matches_website_schema() {
        let snap = MeshVisibilitySnapshot {
            ...
            entry_url: "https://mesh.closedmesh.com".into(),
        ...
        assert_eq!(mv["entry_url"], "https://mesh.closedmesh.com");
