...
echo "☁️ Starting closedmesh MoE HF job"
echo "📦 Model: $MODEL_REF"
echo "🗂️ Dataset repo: $DATASET_REPO"
echo "📥 Release URL: $CLOSEDMESH_RELEASE_URL"
...
url = os.environ["CLOSEDMESH_RELEASE_URL"]
archive = Path("closedmesh-release.tar.gz")
bundle = Path("bundle")
...
chmod +x ./closedmesh ./llama-moe-analyze
