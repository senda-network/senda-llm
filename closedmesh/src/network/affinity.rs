...
fn prefix_only_enabled() -> bool {
    std::env::var("CLOSEDMESH_PREFIX_ONLY")
...
impl AffinityConfig {
    fn from_env() -> Self {
        Self {
            prefix_enabled: std::env::var_os("CLOSEDMESH_DISABLE_PREFIX_AFFINITY").is_none(),
            sticky_enabled: std::env::var_os("CLOSEDMESH_DISABLE_STICKY_ROUTING").is_none(),
        }
    }
}
