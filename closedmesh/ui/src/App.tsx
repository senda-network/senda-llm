...
const FLY_DOMAINS = [
  "closedmesh-console.fly.dev",
  "www.closedmesh.com",
  "www.anarchai.org",
];

const THEME_STORAGE_KEY = "closedmesh-theme";
              ...
              <div className="mx-auto flex h-8 w-full max-w-7xl items-center justify-center gap-2 px-4 text-xs text-muted-foreground">
                ...
                {status?.latest_version ? (
                  <>
                    <span>·</span>
                    <a
                      href="https://github.com/Mesh-LLM/closedmesh/releases"
                      target="_blank"
                      rel="noreferrer"
                      className="underline-offset-2 hover:text-foreground hover:underline"
                      title="A newer closedmesh version is available"
                    >
                      {status?.version
