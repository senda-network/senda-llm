...
/// Service name used for all senda keychain entries.
pub const KEYCHAIN_SERVICE: &str = "senda";
...
/// The prefix matches `DEFAULT_OWNER_ACCOUNT` so users can identify senda
