...
fn build_blackboard_plugin(name: String) -> senda_plugin::SimplePlugin {
    ...
    senda_plugin::plugin! {
        ...
        mesh: [
            senda_plugin::mesh::channel(BLACKBOARD_CHANNEL),
        ],
        events: [
            senda_plugin::events::peer_up(),
        ],
        http: [
            senda_plugin::http::get("/feed")
                .binding_id("feed")
                ...
                .handle(move |request, context| {
                    ...
                    Box::pin(async move {
                        ...
                        let posted = store
                            .post(item)
                            .await
                            .map_err(senda_plugin::PluginError::invalid_params)?;
                        context
                            .send_json_channel(
                                BLACKBOARD_CHANNEL,
                                String::new(),
                            ...
                            .await
                            .map_err(senda_plugin::PluginError::from)?;
                        Ok(posted)
                    })
                }),
        ],
        ...
        on_mesh_event: move |event, context| {
            Box::pin(async move {
                if event.kind() == senda_plugin::proto::mesh_event::Kind::PeerUp {
